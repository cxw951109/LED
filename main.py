...
class A(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_9.addWidget(self.lineEdit_8, 4, 4, 1, 1)
        ...
        self.label_20.setMinimumSize(QtCore.QSize(0, 100))
        self.label_20.setMaximumSize(QtCore.QSize(16777215, 100))
        self.gridLayout_9.addWidget(self.label_20, 4, 3, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.lineEdit_9, 3, 4, 1, 1)
        ...
        self.lineEdit_11.setStyleSheet("border: 1px solid #696969;border-radius: 10px;font: 12pt '幼圆'")
        ...
        self.gridLayout_9.addWidget(self.label_23, 0, 3, 1, 1)
        self.lineEdit_12 = QtWidgets.QLineEdit(Form)
        self.lineEdit_12.setStyleSheet("border: 1px solid #696969;border-radius: 10px;font: 12pt '幼圆'")
        self.lineEdit_12.setMinimumSize(QtCore.QSize(0, 50))
        self.lineEdit_12.setMaximumSize(QtCore.QSize(16777215, 50))
        self.gridLayout_9.addWidget(self.lineEdit_12, 0, 1, 1, 1)
        self.label_24 = QtWidgets.QLabel(Form)
        self.label_24.setMinimumSize(QtCore.QSize(0, 100))
        self.label_24.setMaximumSize(QtCore.QSize(16777215, 100))
        self.gridLayout_9.addWidget(self.label_24, 3, 3, 1, 1)
...
class Ui_Form(QWidget):
    ...
    def switch(self):
        ...
        if sender == "Page0":
            self.remarks =self.Page1.lineEdit_7.text()
            self.wide =self.Page1.lineEdit_8.text()
            self.columns =self.Page1.lineEdit_9.text()
            self.high =self.Page1.lineEdit_10.text()
            self.rows =self.Page1.lineEdit_11.text()
            self.name =self.Page1.lineEdit_12.text()
            if self.wide and self.high and self.columns and self.rows and self.name:
            ...
            if reply == QMessageBox.Yes:
                ...
                session.add(Standard(name=self.message[0], rows=self.message[1], columns=self.message[2],
                               wide=self.message[3], high=self.message[4], remarks=self.message[5],url1='',url2='',
